...
pub struct Stats {
  ...
  #[serde(rename = "latestEPS")] pub latest_eps: f64,
  #[serde(rename = "latestEPSDate")] pub latest_eps_date: String,
  pub shares_outstanding: f64,
  pub float: f64,
  pub return_on_equity: f64,
  #[serde(rename = "consensusEPS")] pub consensus_eps: f64,
  pub number_of_estimates: f64,
  #[serde(rename = "EPSSurprisePercent")] pub eps_surprise_percent: f64,
  #[serde(rename = "EPSSurpriseDollar")] pub eps_surprise_dollar: Option<f64>,
  pub symbol: String,
  #[serde(rename = "EBITDA")] pub ebitda: f64,
  pub revenue: f64,
  pub gross_profit: f64,
  pub cash: f64,
  pub debt: f64,
  #[serde(rename = "ttmEPS")] pub ttm_eps: f64,
